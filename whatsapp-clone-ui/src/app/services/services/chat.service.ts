...
import { getChatsByRecipient } from '../fn/chat/get-chats-by-recipient';
import { GetChatsByRecipient$Params } from '../fn/chat/get-chats-by-recipient';
...
export class ChatService extends BaseService {
  ...
  /** Path part for operation `getChatsByRecipient()` */
  static readonly GetChatsByRecipientPath = '/api/v1/chats';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getChatsByRecipient()` instead.
   *
   * This method doesn't expect any request body.
   */
  getChatsByRecipient$Response(params?: GetChatsByRecipient$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ChatResponse>>> {
    return getChatsByRecipient(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getChatsByRecipient$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getChatsByRecipient(params?: GetChatsByRecipient$Params, context?: HttpContext): Observable<Array<ChatResponse>> {
    return this.getChatsByRecipient$Response(params, context).pipe(
